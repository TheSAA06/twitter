	...
	<div class="main mt-3">
		<div class="container">
			<div class="row">
						...
						<div class="row mt-4">
							...
							<div class="col-xl-10">
									<?php 
										...
										$channel = mysqli_query($connect, "SELECT * FROM channel");
            							...
            							$channel1 = $channel->fetch_assoc();
            							$channel2 = $channel->fetch_assoc();
            							$channel3 = $channel->fetch_assoc();
									 ?>
									<h5><!--
				...
				<form action="insert.php" method="GET">
					<input type="" name="author1" class="form-control">
					<textarea type="" name="channel" class="form-control"></textarea>
					<input type="" name="img1" class="form-control">
